...
using _8_LINQ_com_Lambda.Entities;

namespace _8_LINQ_com_Lambda
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var r2 =
                ...
                select p.Name;
            Print("NAMES OF PRODCTS FROM TOOLS:", r2);
            ...
            Print("PRODUCTS WHERE THE NAME STARTS WITH 'C':", r3);
            ...
            var r9 = products.Where(p => p.Id == 99).SingleOrDefault();
